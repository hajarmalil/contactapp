...
<body>
	<div id="body">
		...
		<br><br><br><br><br><br>
		<div class="alert alert-warning" role="alert"> Wait! Are you sure you want to delete this Address ? </div>
		<br><br><br><br>
		<button type="button" class="btn btn-primary btn-sm" id="btn" onclick="self.location='confirmDelet?ref=${ad.reference}'">Confirm</button>
	</div>
