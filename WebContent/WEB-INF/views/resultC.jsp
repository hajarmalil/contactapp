	...
	<div id="body">
		...
		<ul class="nav nav-pills">
			<li><a href="home"><span class="glyphicon glyphicon-home"></span> Home</a></li>
	  		...
	  		<span class="badge pull-right">${nbc}</span>
	  		Search For Contact <span class="glyphicon glyphicon-search"></span></a></li>
		...
		<div id="listeContacts" class="container-fluid">
			<table class="table table-hover" id="table">
				<tr id="headT"> 
					<th id="t1"> Last Name </th> <th id="t2"> First Name </th> <th id="t5">  </th>
				</tr>
				<c:forEach items="${liste}" var="c">
				<tr id="col"> 
					<td id="t3"> ${c.nom} </td>
					<td id="t4"> ${c.prenom} </td>
					<td id="t6"> <a href="access?idc=${c.adresseMail}">Access To</a> </td>
				</tr>
				</c:forEach>
			</table>
		</div>
