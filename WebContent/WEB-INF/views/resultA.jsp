	...
	<div id="body">
		...
		<ul class="nav nav-pills">
			<li><a href="home"><span class="glyphicon glyphicon-home"></span> Home</a></li>
	  		...
	  		<li class="active"><a href="searchA">
	  		<span class="badge pull-right">${nba}</span>
	  		Search For Address <span class="glyphicon glyphicon-search"></span></a></li>
		</ul>
		<br><br><br><br><br><br>
		<div id="listeAddress" class="container-fluid">
			<table class="table table-hover" id="table">
				<tr id="headT"> 
					<th id="t1"> List Of Addresses </th> 
				</tr>
				<c:forEach items="${list}" var="a">
				<tr id="col"> 
					<td id="t3"> ${a.numero} ${a.rue}, ${a.codePostale} ${a.ville}, ${a.pays} </td>
				</tr>
				</c:forEach>
			</table>
		</div>
