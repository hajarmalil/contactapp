...
<body>
	<div id="body">
	<f:form modelAttribute="contact" method="post" action="searchContact"> 
		...
		<ul class="nav nav-pills">
			<li><a href="home"><span class="glyphicon glyphicon-home"></span> Home</a></li>
	  		...
	  		<li class="active"><a href="search">Search For Contact <span class="glyphicon glyphicon-search"></span></a></li>
