...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/Bootstrap/CSS/table.css">
</head>
<body>
	<div id="body">
		...
		<br><br><br><br><br><br>
		<div class="alert alert-success" role="alert"> Congratulation !! You successfully update the Address. </div>
	</div>
