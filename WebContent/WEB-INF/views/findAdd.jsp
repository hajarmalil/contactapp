...
<body>
	<div id="body">
	<f:form modelAttribute="adresse" method="post" action="findAdd"> 
		...
		<ul class="nav nav-pills">
	  		...
	  		<li class="active"><a href="searchAddress">Search For Address <span class="glyphicon glyphicon-search"></span></a></li>
		</ul>
		<br><br><br><br><br><br>
