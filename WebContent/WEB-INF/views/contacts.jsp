	...
	<div id="body">
		...
		<div id="listeContacts" class="container-fluid">
			<table class="table table-hover" id="table">
				<tr id="headT"> 
					<th id="t1"> Last Name </th> <th id="t2"> First Name </th> <th id="t5">  </th> <th id="t5">  </th>
				</tr>
				<c:forEach items="${liste}" var="contact">
				<tr id="col"> 
					<td id="t3"> ${contact.nom} </td>
					<td id="t4"> ${contact.prenom} </td>
					<td id="t6"> <a href="access?idc=${contact.adresseMail}">Access To</a> </td>
					<td id="t7"> <span class="glyphicon glyphicon-user"></span> </td>
				</tr>
				</c:forEach>
				<tr id="headT"> 
					<th id="t1"> </th> <th id="t2"> </th> <th id="t5">  </th> <th id="t5">  </th>
				</tr>
			</table>
		</div>
		<br>
