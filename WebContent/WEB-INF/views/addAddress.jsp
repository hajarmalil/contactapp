...
<body>
	<div id="body">
	<f:form modelAttribute="adresse" method="post" action="saveNewAddress"> 
		...
		<ul class="nav nav-pills">
	  		...
	  		<li class="active"><a href="addAddress">Add Address <span class="glyphicon glyphicon-plus"></span></a></li>
		...
		<div class="input-group">
		  ...
		  <f:input type="text" class="form-control" placeholder="" path="type"/>
		</div>
		<br><br><br><br>
